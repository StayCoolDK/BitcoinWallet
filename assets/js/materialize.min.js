...
$(document).on("click", ".sendTransaction", function(){
  swal({
    ...
    html: "Transactions on Bitcoin's blockchain are irreversable. Please confirm that the following information about the transaction is correct:<br><br> Address: <b>1KFHE7w8BhaENAswwryaoccDb6qcT6DbYY</b> <br> Amount: <b>0.025432 ฿</b>",
